...
import com.juaracoding.projectJC.utils.TestScenarioContactNegatif;
...
public class HooksContactNegative {
	...
	public void setup() {
		...
		TestScenarioContactNegatif[] tests = TestScenarioContactNegatif.values();
